...
def train_one_epoch(model: torch.nn.Module,
    ...
    for data_iter_step, (samples, highres) in enumerate(metric_logger.log_every(data_loader, print_freq, header)):
        ...
        print('samples',samples.shape, highres.shape)

        with torch.cuda.amp.autocast():
            loss, _, _ = model(samples, highres, mask_ratio=args.mask_ratio)
