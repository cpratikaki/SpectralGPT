...
import superres_models_mae_spectral

from superres_engine_pretrain import train_one_epoch, train_one_epoch_temporal
...
def main(args):
    ...
    if args.model_type == 'group_c':
        ...
        model = superres_models_mae_spectral.__dict__[args.model]()
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir and (epoch % 60 == 0 or epoch + 1 == args.epochs):
            misc.save_model(
