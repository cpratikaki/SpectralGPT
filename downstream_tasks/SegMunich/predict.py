...
def main():
    ...
    weights_path = "/home/tiiairc/GenAI/SpectralGPT/multi_train_seg/model_multi_10.pth"
    ...
    # load image
    image_folder_path ="/home/tiiairc/GenAI/Datasets/SegMunich/test/img"#"/TUM/img"
    ...
    for image_file_name in image_file_names:
        ...
        with torch.no_grad():
            ...
            mask.save(os.path.join("/home/tiiairc/GenAI/SpectralGPT/multi_train_seg/predictions", image_file_name))
